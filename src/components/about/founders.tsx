  ...
  const founders = [
    {
      ...
      linkedin: 'https://www.linkedin.com/in/isaac-nnamdi',
    ...
    },
    {
      ...
      linkedin: 'https://www.linkedin.com/in/sarah-effiong',
      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {founders.map((founder, i) => (
            <div
              key={i}
              className="bg-white rounded-[40px] overflow-hidden shadow-sm flex flex-col md:flex-row border border-slate-100 group hover:shadow-xl transition-all duration-500"
            >
              <div className="w-full md:w-64 h-80 md:h-auto overflow-hidden flex items-center justify-center">
                <img
                  src={founder.img}
                  alt={founder.name}
